...
checkpoint = ModelCheckpoint("100-model-best.hd5f", monitor='loss', verbose=1,
...
class ConvolutionalModel(MLModel):
    ...
    def __init__(self, dataSet=None):
        ...
        self.shape = numpy.array([constant.IMG_WIDTH, constant.IMG_HEIGHT, 3])
    ...
    def train(self, n_epochs=20, batch=32):
        self.cnn.fit(self.objects, self.labels,
                       batch_size=batch,
                       epochs=n_epochs, shuffle=True, callbacks=[checkpoint])
